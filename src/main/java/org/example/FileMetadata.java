...
public class FileMetadata {
    ...
    public static class Builder {
        ...
        private void validateLayoutInvariants() {
            // Basic schema sanity
            require(InodeTable.INODE_SIZE > 0, "inode size must be > 0");
            ...
            require(InodeSchema.FILE_DISK_BLOCK_POINTERS_BYTE_OFFSET <= InodeTable.INODE_SIZE,
                    "direct pointers offset must be <= inode size");
            require((InodeTable.INODE_SIZE - InodeSchema.FILE_DISK_BLOCK_POINTERS_BYTE_OFFSET) % InodeSchema.FILE_DISK_BLOCK_POINTER_LEN == 0,
    ...
    public static class InodeSchema {
        ...
        static final int TOTAL_NUMBER_OF_ADDRESSABLE_DISK_BLOCK_POINTERS = (InodeTable.INODE_SIZE - FILE_DISK_BLOCK_POINTERS_BYTE_OFFSET) / FILE_DISK_BLOCK_POINTER_LEN;
